...
public class AcakGrupBaru extends AppCompatActivity {
    FloatingActionButton share_fab;
    FloatingActionButton share_fab2;
    ListView list_acak_grup_baru;
    String share_text;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_acak_grup_baru);
        ...
        if (jumlah_team.length() > 0 ){
            list_acak_grup_baru = (ListView) findViewById(R.id.list_acak_grup_baru);
            ...
            if (hasilRandom.length > 1){
                ...
                list_acak_grup_baru.setAdapter(arrayAdapter);
            }else{
